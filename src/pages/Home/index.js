...
const Home = () => {
    ...
    useEffect( () => {
        async function Solicitacao( url ) {
            const response = await api.get( url );
        }

        const user = Solicitacao("/Elismar13");
        const repositorios = Solicitacao("/Elismar13/repos?&sort=update");
    ...
    return (
            <div className="Container">
                <h1 className="MeuNome">Elismar13</h1>
                    <section className="Descricao">
                        <p>Olá! Me chamo Elismar Silva Pereira, tenho 18 anos e sou de uma pequena cidade 
